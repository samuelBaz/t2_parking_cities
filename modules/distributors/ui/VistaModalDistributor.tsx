...
import { CreateEditInspectorType } from "@/modules/users/types/UserTypes"
...
export const VistaModalDistributor = ({
  accionCorrecta,
  accionCancelar,
}: ModalParametroType) => {
  ...
  const { handleSubmit, control, watch } = useForm<CreateEditDistributorTypeForm>({
    defaultValues: {
      id: undefined,
...
export default VistaModalDistributor